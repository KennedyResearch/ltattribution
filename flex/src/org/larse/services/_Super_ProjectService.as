...
internal class _Super_ProjectService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_ProjectService()
    {
        ...
        org.larse.vos.LandtrendrTask._initRemoteClassAlias();
        ...
        operation.resultElementType = org.larse.vos.LandtrendrTask;
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getUserTasks(interpreter:int) : mx.rpc.AsyncToken
    {
