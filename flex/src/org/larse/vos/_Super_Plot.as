...
public class _Super_Plot extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    private var _internal_dist_year : int;
    private var _internal_plotid : int;
    private var _internal_project_id : int;
    private var _internal_sequence_order : int;
    ...
    [Bindable(event="propertyChange")]
    public function get dist_year() : int
    {
        return _internal_dist_year;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get sequence_order() : int
    {
    ...
    public function set dist_year(value:int) : void
    {
        var oldValue:int = _internal_dist_year;
        if (oldValue !== value)
        {
            _internal_dist_year = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "dist_year", oldValue, _internal_dist_year));
        }
    }
    ...
    public function set sequence_order(value:int) : void
    {
        var oldValue:int = _internal_sequence_order;
        if (oldValue !== value)
        {
            _internal_sequence_order = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "sequence_order", oldValue, _internal_sequence_order));
        }
    }
