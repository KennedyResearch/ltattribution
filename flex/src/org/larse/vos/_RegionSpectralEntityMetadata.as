...
internal class _RegionSpectralEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("tcg", "tsa", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("tcg", "tsa", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("tcg", "tsa", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("tcg", "tsa", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("tcg", "tsa", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover");
