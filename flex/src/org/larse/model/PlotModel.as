package org.larse.model
{
	...
	[Event(name="plot_process_modified",type="org.larse.events.PlotEvent")]
	[Event(name="plot_vertex_modified",type="org.larse.events.PlotEvent")]
	[ManagedEvents("plot_vertex_modified,plot_process_modified,plot_spectral_loaded,get_all_plots,plot_selection_changed,plot_model_changed")]
	public class PlotModel extends EventDispatcher
	{
		private var _plots:ArrayCollection;
		...
		public function plotModified(evtype:String):void {
			dispatchEvent(new PlotEvent(evtype));
		}
	}
}